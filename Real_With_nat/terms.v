...
Definition real_abs : real -> real := fun _24160 : real => @COND real (real_le (real_of_num (NUMERAL O)) _24160) _24160 (real_neg _24160).
Lemma real_abs_def : real_abs = (fun _24160 : real => @COND real (real_le (real_of_num (NUMERAL O)) _24160) _24160 (real_neg _24160)).
Proof. exact (REFL real_abs). Qed.
Definition real_pow : real -> nat -> real := @ε ((prod nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat))))))) -> real -> nat -> real) (fun real_pow' : (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat))))))) -> real -> nat -> real => forall _24171 : prod nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat)))))), (forall x : real, (real_pow' _24171 x (NUMERAL O)) = (real_of_num (NUMERAL (BIT1 O)))) /\ (forall x : real, forall n : nat, (real_pow' _24171 x (S n)) = (real_mul x (real_pow' _24171 x n)))) (@pair nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat)))))) (NUMERAL (BIT0 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat (prod nat (prod nat (prod nat nat))))) (NUMERAL (BIT1 (BIT0 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat (prod nat (prod nat nat)))) (NUMERAL (BIT1 (BIT0 (BIT0 (BIT0 (BIT0 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat (prod nat nat))) (NUMERAL (BIT0 (BIT0 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat nat)) (NUMERAL (BIT1 (BIT1 (BIT1 (BIT1 (BIT1 (BIT0 (BIT1 O)))))))) (@pair nat (prod nat nat) (NUMERAL (BIT0 (BIT0 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 O)))))))) (@pair nat nat (NUMERAL (BIT1 (BIT1 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 O)))))))) (NUMERAL (BIT1 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 (BIT1 O))))))))))))))).
Lemma real_pow_def : real_pow = (@ε ((prod nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat))))))) -> real -> nat -> real) (fun real_pow' : (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat))))))) -> real -> nat -> real => forall _24171 : prod nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat)))))), (forall x : real, (real_pow' _24171 x (NUMERAL O)) = (real_of_num (NUMERAL (BIT1 O)))) /\ (forall x : real, forall n : nat, (real_pow' _24171 x (S n)) = (real_mul x (real_pow' _24171 x n)))) (@pair nat (prod nat (prod nat (prod nat (prod nat (prod nat (prod nat nat)))))) (NUMERAL (BIT0 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat (prod nat (prod nat (prod nat nat))))) (NUMERAL (BIT1 (BIT0 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat (prod nat (prod nat nat)))) (NUMERAL (BIT1 (BIT0 (BIT0 (BIT0 (BIT0 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat (prod nat nat))) (NUMERAL (BIT0 (BIT0 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 O)))))))) (@pair nat (prod nat (prod nat nat)) (NUMERAL (BIT1 (BIT1 (BIT1 (BIT1 (BIT1 (BIT0 (BIT1 O)))))))) (@pair nat (prod nat nat) (NUMERAL (BIT0 (BIT0 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 O)))))))) (@pair nat nat (NUMERAL (BIT1 (BIT1 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 O)))))))) (NUMERAL (BIT1 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 (BIT1 O)))))))))))))))).
...
Definition real_sgn : real -> real := fun _26684 : real => @COND real (real_lt (real_of_num (NUMERAL O)) _26684) (real_of_num (NUMERAL (BIT1 O))) (@COND real (real_lt _26684 (real_of_num (NUMERAL O))) (real_neg (real_of_num (NUMERAL (BIT1 O)))) (real_of_num (NUMERAL O))).
Lemma real_sgn_def : real_sgn = (fun _26684 : real => @COND real (real_lt (real_of_num (NUMERAL O)) _26684) (real_of_num (NUMERAL (BIT1 O))) (@COND real (real_lt _26684 (real_of_num (NUMERAL O))) (real_neg (real_of_num (NUMERAL (BIT1 O)))) (real_of_num (NUMERAL O)))).
Proof. exact (REFL real_sgn). Qed.
Definition sqrt : real -> real := fun _27235 : real => @ε real (fun y : real => ((real_sgn y) = (real_sgn _27235)) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 O)))) = (real_abs _27235))).
Lemma sqrt_def : sqrt = (fun _27235 : real => @ε real (fun y : real => ((real_sgn y) = (real_sgn _27235)) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 O)))) = (real_abs _27235)))).
