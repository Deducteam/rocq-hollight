Require Import mathcomp.classical.classical_sets HOLLight.Real_With_nat.mappings.
...
Axiom thm_SUC_SUB1 : forall n : N, (N.sub (N.succ n) (NUMERAL (BIT1 N0))) = n.
...
Axiom thm_LIST_OF_SEQ : forall {A : Type'}, (forall f : N -> A, (@list_of_Nseq A f (NUMERAL N0)) = (@nil A)) /\ (forall f : N -> A, forall n : N, (@list_of_Nseq A f (N.succ n)) = (@cons A (f (NUMERAL N0)) (@list_of_Nseq A (@o N N A f N.succ) n))).
...
Axiom thm_REAL_ADD_LID : forall x : real, (real_add (real_of_num (NUMERAL N0)) x) = x.
Axiom thm_REAL_ADD_LINV : forall x : real, (real_add (real_neg x) x) = (real_of_num (NUMERAL N0)).
...
Axiom thm_REAL_MUL_LID : forall x : real, (real_mul (real_of_num (NUMERAL (BIT1 N0))) x) = x.
...
Axiom thm_REAL_LE_MUL : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le (real_of_num (NUMERAL N0)) y)) -> real_le (real_of_num (NUMERAL N0)) (real_mul x y).
Axiom thm_REAL_INV_0 : (real_inv (real_of_num (NUMERAL N0))) = (real_of_num (NUMERAL N0)).
Axiom thm_REAL_MUL_LINV : forall x : real, (~ (x = (real_of_num (NUMERAL N0)))) -> (real_mul (real_inv x) x) = (real_of_num (NUMERAL (BIT1 N0))).
...
Axiom thm_real_abs : forall x : real, (real_abs x) = (@COND real (real_le (real_of_num (NUMERAL N0)) x) x (real_neg x)).
Axiom thm_real_pow : forall (x : real), ((real_pow x (NUMERAL N0)) = (real_of_num (NUMERAL (BIT1 N0)))) /\ (forall n : N, (real_pow x (N.succ n)) = (real_mul x (real_pow x n))).
...
Axiom thm_REAL_HREAL_LEMMA1 : exists r : hreal -> real, (forall x : real, (real_le (real_of_num (NUMERAL N0)) x) = (exists y : hreal, x = (r y))) /\ (forall y : hreal, forall z : hreal, (hreal_le y z) = (real_le (r y) (r z))).
Axiom thm_REAL_HREAL_LEMMA2 : exists h : real -> hreal, exists r : hreal -> real, (forall x : hreal, (h (r x)) = x) /\ ((forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> (r (h x)) = x) /\ ((forall x : hreal, real_le (real_of_num (NUMERAL N0)) (r x)) /\ (forall x : hreal, forall y : hreal, (hreal_le x y) = (real_le (r x) (r y))))).
Axiom thm_REAL_COMPLETE_SOMEPOS : forall P : real -> Prop, ((exists x : real, (P x) /\ (real_le (real_of_num (NUMERAL N0)) x)) /\ (exists M : real, forall x : real, (P x) -> real_le x M)) -> exists M : real, (forall x : real, (P x) -> real_le x M) /\ (forall M' : real, (forall x : real, (P x) -> real_le x M') -> real_le M M').
...
Axiom thm_REAL_ADD_RINV : forall x : real, (real_add x (real_neg x)) = (real_of_num (NUMERAL N0)).
...
Axiom thm_REAL_MUL_RZERO : forall x : real, (real_mul x (real_of_num (NUMERAL N0))) = (real_of_num (NUMERAL N0)).
Axiom thm_REAL_MUL_LZERO : forall x : real, (real_mul (real_of_num (NUMERAL N0)) x) = (real_of_num (NUMERAL N0)).
...
Axiom thm_REAL_ADD_RID : forall x : real, (real_add x (real_of_num (NUMERAL N0))) = x.
Axiom thm_REAL_NEG_0 : (real_neg (real_of_num (NUMERAL N0))) = (real_of_num (NUMERAL N0)).
Axiom thm_REAL_LE_LNEG : forall x : real, forall y : real, (real_le (real_neg x) y) = (real_le (real_of_num (NUMERAL N0)) (real_add x y)).
Axiom thm_REAL_LE_NEG2 : forall x : real, forall y : real, (real_le (real_neg x) (real_neg y)) = (real_le y x).
Axiom thm_REAL_LE_RNEG : forall x : real, forall y : real, (real_le x (real_neg y)) = (real_le (real_add x y) (real_of_num (NUMERAL N0))).
...
Axiom thm_REAL_LE_ADD : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le (real_of_num (NUMERAL N0)) y)) -> real_le (real_of_num (NUMERAL N0)) (real_add x y).
Axiom thm_REAL_LTE_ANTISYM : forall x : real, forall y : real, ~ ((real_lt x y) /\ (real_le y x)).
Axiom thm_REAL_SUB_LE : forall x : real, forall y : real, (real_le (real_of_num (NUMERAL N0)) (real_sub x y)) = (real_le y x).
...
Axiom thm_REAL_SUB_LT : forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL N0)) (real_sub x y)) = (real_lt y x).
Axiom thm_REAL_NOT_LT : forall x : real, forall y : real, (~ (real_lt x y)) = (real_le y x).
Axiom thm_REAL_SUB_0 : forall x : real, forall y : real, ((real_sub x y) = (real_of_num (NUMERAL N0))) = (x = y).
...
Axiom thm_REAL_LTE_ADD : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_le (real_of_num (NUMERAL N0)) y)) -> real_lt (real_of_num (NUMERAL N0)) (real_add x y).
Axiom thm_REAL_LET_ADD : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_of_num (NUMERAL N0)) y)) -> real_lt (real_of_num (NUMERAL N0)) (real_add x y).
Axiom thm_REAL_LT_ADD : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_of_num (NUMERAL N0)) y)) -> real_lt (real_of_num (NUMERAL N0)) (real_add x y).
Axiom thm_REAL_ENTIRE : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (NUMERAL N0))) = ((x = (real_of_num (NUMERAL N0))) \/ (y = (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_LE_NEGTOTAL : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) \/ (real_le (real_of_num (NUMERAL N0)) (real_neg x)).
Axiom thm_REAL_LE_SQUARE : forall x : real, real_le (real_of_num (NUMERAL N0)) (real_mul x x).
Axiom thm_REAL_MUL_RID : forall x : real, (real_mul x (real_of_num (NUMERAL (BIT1 N0)))) = x.
Axiom thm_REAL_POW_2 : forall x : real, (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) = (real_mul x x).
Axiom thm_REAL_POLY_CLAUSES : (forall x : real, forall y : real, forall z : real, (real_add x (real_add y z)) = (real_add (real_add x y) z)) /\ ((forall x : real, forall y : real, (real_add x y) = (real_add y x)) /\ ((forall x : real, (real_add (real_of_num (NUMERAL N0)) x) = x) /\ ((forall x : real, forall y : real, forall z : real, (real_mul x (real_mul y z)) = (real_mul (real_mul x y) z)) /\ ((forall x : real, forall y : real, (real_mul x y) = (real_mul y x)) /\ ((forall x : real, (real_mul (real_of_num (NUMERAL (BIT1 N0))) x) = x) /\ ((forall x : real, (real_mul (real_of_num (NUMERAL N0)) x) = (real_of_num (NUMERAL N0))) /\ ((forall x : real, forall y : real, forall z : real, (real_mul x (real_add y z)) = (real_add (real_mul x y) (real_mul x z))) /\ ((forall x : real, (real_pow x (NUMERAL N0)) = (real_of_num (NUMERAL (BIT1 N0)))) /\ (forall x : real, forall n : N, (real_pow x (N.succ n)) = (real_mul x (real_pow x n))))))))))).
Axiom thm_REAL_POLY_NEG_CLAUSES : (forall x : real, (real_neg x) = (real_mul (real_neg (real_of_num (NUMERAL (BIT1 N0)))) x)) /\ (forall x : real, forall y : real, (real_sub x y) = (real_add x (real_mul (real_neg (real_of_num (NUMERAL (BIT1 N0)))) y))).
Axiom thm_REAL_POS : forall n : N, real_le (real_of_num (NUMERAL N0)) (real_of_num n).
Axiom thm_REAL_LT_NZ : forall n : N, (~ ((real_of_num n) = (real_of_num (NUMERAL N0)))) = (real_lt (real_of_num (NUMERAL N0)) (real_of_num n)).
Axiom thm_REAL_POS_LT : forall n : N, real_lt (real_of_num (NUMERAL N0)) (real_of_num (N.succ n)).
...
Axiom thm_REAL_OF_NUM_SUC : forall n : N, (real_add (real_of_num n) (real_of_num (NUMERAL (BIT1 N0)))) = (real_of_num (N.succ n)).
...
Axiom thm_REAL_LT_MUL : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_of_num (NUMERAL N0)) y)) -> real_lt (real_of_num (NUMERAL N0)) (real_mul x y).
Axiom thm_REAL_EQ_ADD_LCANCEL_0 : forall x : real, forall y : real, ((real_add x y) = x) = (y = (real_of_num (NUMERAL N0))).
Axiom thm_REAL_EQ_ADD_RCANCEL_0 : forall x : real, forall y : real, ((real_add x y) = y) = (x = (real_of_num (NUMERAL N0))).
Axiom thm_REAL_LNEG_UNIQ : forall x : real, forall y : real, ((real_add x y) = (real_of_num (NUMERAL N0))) = (x = (real_neg y)).
Axiom thm_REAL_RNEG_UNIQ : forall x : real, forall y : real, ((real_add x y) = (real_of_num (NUMERAL N0))) = (y = (real_neg x)).
...
Axiom thm_REAL_NEG_LT0 : forall x : real, (real_lt (real_neg x) (real_of_num (NUMERAL N0))) = (real_lt (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_NEG_GT0 : forall x : real, (real_lt (real_of_num (NUMERAL N0)) (real_neg x)) = (real_lt x (real_of_num (NUMERAL N0))).
Axiom thm_REAL_NEG_LE0 : forall x : real, (real_le (real_neg x) (real_of_num (NUMERAL N0))) = (real_le (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_NEG_GE0 : forall x : real, (real_le (real_of_num (NUMERAL N0)) (real_neg x)) = (real_le x (real_of_num (NUMERAL N0))).
Axiom thm_REAL_LT_TOTAL : forall x : real, forall y : real, (x = y) \/ ((real_lt x y) \/ (real_lt y x)).
Axiom thm_REAL_LT_NEGTOTAL : forall x : real, (x = (real_of_num (NUMERAL N0))) \/ ((real_lt (real_of_num (NUMERAL N0)) x) \/ (real_lt (real_of_num (NUMERAL N0)) (real_neg x))).
Axiom thm_REAL_LE_01 : real_le (real_of_num (NUMERAL N0)) (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_LT_01 : real_lt (real_of_num (NUMERAL N0)) (real_of_num (NUMERAL (BIT1 N0))).
...
Axiom thm_REAL_LT_LNEG : forall x : real, forall y : real, (real_lt (real_neg x) y) = (real_lt (real_of_num (NUMERAL N0)) (real_add x y)).
Axiom thm_REAL_LT_RNEG : forall x : real, forall y : real, (real_lt x (real_neg y)) = (real_lt (real_add x y) (real_of_num (NUMERAL N0))).
...
Axiom thm_REAL_LT_ADD1 : forall x : real, forall y : real, (real_le x y) -> real_lt x (real_add y (real_of_num (NUMERAL (BIT1 N0)))).
...
Axiom thm_REAL_SUB_REFL : forall x : real, (real_sub x x) = (real_of_num (NUMERAL N0)).
Axiom thm_REAL_LE_DOUBLE : forall x : real, (real_le (real_of_num (NUMERAL N0)) (real_add x x)) = (real_le (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_LE_NEGL : forall x : real, (real_le (real_neg x) x) = (real_le (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_LE_NEGR : forall x : real, (real_le x (real_neg x)) = (real_le x (real_of_num (NUMERAL N0))).
Axiom thm_REAL_NEG_EQ_0 : forall x : real, ((real_neg x) = (real_of_num (NUMERAL N0))) = (x = (real_of_num (NUMERAL N0))).
...
Axiom thm_REAL_NEG_MINUS1 : forall x : real, (real_neg x) = (real_mul (real_neg (real_of_num (NUMERAL (BIT1 N0)))) x).
Axiom thm_REAL_LT_IMP_NE : forall x : real, forall y : real, (real_lt x y) -> ~ (x = y).
Axiom thm_REAL_LE_ADDR : forall x : real, forall y : real, (real_le x (real_add x y)) = (real_le (real_of_num (NUMERAL N0)) y).
Axiom thm_REAL_LE_ADDL : forall x : real, forall y : real, (real_le y (real_add x y)) = (real_le (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_LT_ADDR : forall x : real, forall y : real, (real_lt x (real_add x y)) = (real_lt (real_of_num (NUMERAL N0)) y).
Axiom thm_REAL_LT_ADDL : forall x : real, forall y : real, (real_lt y (real_add x y)) = (real_lt (real_of_num (NUMERAL N0)) x).
...
Axiom thm_REAL_SUB_LZERO : forall x : real, (real_sub (real_of_num (NUMERAL N0)) x) = (real_neg x).
Axiom thm_REAL_SUB_RZERO : forall x : real, (real_sub x (real_of_num (NUMERAL N0))) = x.
...
Axiom thm_REAL_LT_IMP_NZ : forall x : real, (real_lt (real_of_num (NUMERAL N0)) x) -> ~ (x = (real_of_num (NUMERAL N0))).
...
Axiom thm_REAL_ABS_ZERO : forall x : real, ((real_abs x) = (real_of_num (NUMERAL N0))) = (x = (real_of_num (NUMERAL N0))).
Axiom thm_REAL_ABS_0 : (real_abs (real_of_num (NUMERAL N0))) = (real_of_num (NUMERAL N0)).
Axiom thm_REAL_ABS_1 : (real_abs (real_of_num (NUMERAL (BIT1 N0)))) = (real_of_num (NUMERAL (BIT1 N0))).
...
Axiom thm_REAL_ABS_POS : forall x : real, real_le (real_of_num (NUMERAL N0)) (real_abs x).
Axiom thm_REAL_ABS_SUB : forall x : real, forall y : real, (real_abs (real_sub x y)) = (real_abs (real_sub y x)).
Axiom thm_REAL_ABS_NZ : forall x : real, (~ (x = (real_of_num (NUMERAL N0)))) = (real_lt (real_of_num (NUMERAL N0)) (real_abs x)).
...
Axiom thm_REAL_ABS_REFL : forall x : real, ((real_abs x) = x) = (real_le (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_ABS_BETWEEN : forall x : real, forall y : real, forall d : real, ((real_lt (real_of_num (NUMERAL N0)) d) /\ ((real_lt (real_sub x d) y) /\ (real_lt y (real_add x d)))) = (real_lt (real_abs (real_sub y x)) d).
...
Axiom thm_REAL_ABS_STILLNZ : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) (real_abs y)) -> ~ (x = (real_of_num (NUMERAL N0))).
Axiom thm_REAL_ABS_CASES : forall x : real, (x = (real_of_num (NUMERAL N0))) \/ (real_lt (real_of_num (NUMERAL N0)) (real_abs x)).
...
Axiom thm_REAL_ABS_SIGN : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) y) -> real_lt (real_of_num (NUMERAL N0)) x.
Axiom thm_REAL_ABS_SIGN2 : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) (real_neg y)) -> real_lt x (real_of_num (NUMERAL N0)).
...
Axiom thm_REAL_ABS_BETWEEN2 : forall x0 : real, forall x : real, forall y0 : real, forall y : real, ((real_lt x0 y0) /\ ((real_lt (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) (real_abs (real_sub x x0))) (real_sub y0 x0)) /\ (real_lt (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) (real_abs (real_sub y y0))) (real_sub y0 x0)))) -> real_lt x y.
...
Axiom thm_REAL_POW_LE : forall x : real, forall n : N, (real_le (real_of_num (NUMERAL N0)) x) -> real_le (real_of_num (NUMERAL N0)) (real_pow x n).
Axiom thm_REAL_POW_LT : forall x : real, forall n : N, (real_lt (real_of_num (NUMERAL N0)) x) -> real_lt (real_of_num (NUMERAL N0)) (real_pow x n).
Axiom thm_REAL_ABS_POW : forall x : real, forall n : N, (real_abs (real_pow x n)) = (real_pow (real_abs x) n).
Axiom thm_REAL_LE_LMUL : forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le y z)) -> real_le (real_mul x y) (real_mul x z).
Axiom thm_REAL_LE_RMUL : forall x : real, forall y : real, forall z : real, ((real_le x y) /\ (real_le (real_of_num (NUMERAL N0)) z)) -> real_le (real_mul x z) (real_mul y z).
Axiom thm_REAL_LT_LMUL : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt y z)) -> real_lt (real_mul x y) (real_mul x z).
Axiom thm_REAL_LT_RMUL : forall x : real, forall y : real, forall z : real, ((real_lt x y) /\ (real_lt (real_of_num (NUMERAL N0)) z)) -> real_lt (real_mul x z) (real_mul y z).
Axiom thm_REAL_EQ_MUL_LCANCEL : forall x : real, forall y : real, forall z : real, ((real_mul x y) = (real_mul x z)) = ((x = (real_of_num (NUMERAL N0))) \/ (y = z)).
Axiom thm_REAL_EQ_MUL_RCANCEL : forall x : real, forall y : real, forall z : real, ((real_mul x z) = (real_mul y z)) = ((x = y) \/ (z = (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_MUL_LINV_UNIQ : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (NUMERAL (BIT1 N0)))) -> (real_inv y) = x.
Axiom thm_REAL_MUL_RINV_UNIQ : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (NUMERAL (BIT1 N0)))) -> (real_inv x) = y.
...
Axiom thm_REAL_INV_EQ_0 : forall x : real, ((real_inv x) = (real_of_num (NUMERAL N0))) = (x = (real_of_num (NUMERAL N0))).
Axiom thm_REAL_LT_INV : forall x : real, (real_lt (real_of_num (NUMERAL N0)) x) -> real_lt (real_of_num (NUMERAL N0)) (real_inv x).
Axiom thm_REAL_LT_INV_EQ : forall x : real, (real_lt (real_of_num (NUMERAL N0)) (real_inv x)) = (real_lt (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_INV_NEG : forall x : real, (real_inv (real_neg x)) = (real_neg (real_inv x)).
Axiom thm_REAL_LE_INV_EQ : forall x : real, (real_le (real_of_num (NUMERAL N0)) (real_inv x)) = (real_le (real_of_num (NUMERAL N0)) x).
Axiom thm_REAL_LE_INV : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> real_le (real_of_num (NUMERAL N0)) (real_inv x).
Axiom thm_REAL_MUL_RINV : forall x : real, (~ (x = (real_of_num (NUMERAL N0)))) -> (real_mul x (real_inv x)) = (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_INV_1 : (real_inv (real_of_num (NUMERAL (BIT1 N0)))) = (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_INV_EQ_1 : forall x : real, ((real_inv x) = (real_of_num (NUMERAL (BIT1 N0)))) = (x = (real_of_num (NUMERAL (BIT1 N0)))).
Axiom thm_REAL_DIV_1 : forall x : real, (real_div x (real_of_num (NUMERAL (BIT1 N0)))) = x.
Axiom thm_REAL_DIV_REFL : forall x : real, (~ (x = (real_of_num (NUMERAL N0)))) -> (real_div x x) = (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_DIV_RMUL : forall x : real, forall y : real, (~ (y = (real_of_num (NUMERAL N0)))) -> (real_mul (real_div x y) y) = x.
Axiom thm_REAL_DIV_LMUL : forall x : real, forall y : real, (~ (y = (real_of_num (NUMERAL N0)))) -> (real_mul y (real_div x y)) = x.
Axiom thm_REAL_DIV_EQ_1 : forall x : real, forall y : real, ((real_div x y) = (real_of_num (NUMERAL (BIT1 N0)))) = ((x = y) /\ ((~ (x = (real_of_num (NUMERAL N0)))) /\ (~ (y = (real_of_num (NUMERAL N0)))))).
...
Axiom thm_REAL_DIV_EQ_0 : forall x : real, forall y : real, ((real_div x y) = (real_of_num (NUMERAL N0))) = ((x = (real_of_num (NUMERAL N0))) \/ (y = (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_POW_ADD : forall x : real, forall m : N, forall n : N, (real_pow x (N.add m n)) = (real_mul (real_pow x m) (real_pow x n)).
Axiom thm_REAL_POW_NZ : forall x : real, forall n : N, (~ (x = (real_of_num (NUMERAL N0)))) -> ~ ((real_pow x n) = (real_of_num (NUMERAL N0))).
Axiom thm_REAL_POW_SUB : forall x : real, forall m : N, forall n : N, ((~ (x = (real_of_num (NUMERAL N0)))) /\ (N.le m n)) -> (real_pow x (N.sub n m)) = (real_div (real_pow x n) (real_pow x m)).
Axiom thm_REAL_LT_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_mul x y) (real_mul x z))) -> real_lt y z.
Axiom thm_REAL_LT_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL N0)) z) /\ (real_lt (real_mul x z) (real_mul y z))) -> real_lt x y.
Axiom thm_REAL_LE_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_le (real_mul x y) (real_mul x z))) -> real_le y z.
Axiom thm_REAL_LE_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL N0)) z) /\ (real_le (real_mul x z) (real_mul y z))) -> real_le x y.
Axiom thm_REAL_LE_RMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_le (real_mul x z) (real_mul y z)) = (real_le x y).
Axiom thm_REAL_LE_LMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_le (real_mul z x) (real_mul z y)) = (real_le x y).
Axiom thm_REAL_LT_RMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_lt (real_mul x z) (real_mul y z)) = (real_lt x y).
Axiom thm_REAL_LT_LMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_lt (real_mul z x) (real_mul z y)) = (real_lt x y).
Axiom thm_REAL_LE_MUL_EQ : (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL N0)) x) -> (real_le (real_of_num (NUMERAL N0)) (real_mul x y)) = (real_le (real_of_num (NUMERAL N0)) y)) /\ (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL N0)) y) -> (real_le (real_of_num (NUMERAL N0)) (real_mul x y)) = (real_le (real_of_num (NUMERAL N0)) x)).
Axiom thm_REAL_LT_MUL_EQ : (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL N0)) x) -> (real_lt (real_of_num (NUMERAL N0)) (real_mul x y)) = (real_lt (real_of_num (NUMERAL N0)) y)) /\ (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL N0)) y) -> (real_lt (real_of_num (NUMERAL N0)) (real_mul x y)) = (real_lt (real_of_num (NUMERAL N0)) x)).
Axiom thm_REAL_MUL_POS_LT : forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL N0)) (real_mul x y)) = (((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_of_num (NUMERAL N0)) y)) \/ ((real_lt x (real_of_num (NUMERAL N0))) /\ (real_lt y (real_of_num (NUMERAL N0))))).
Axiom thm_REAL_MUL_POS_LE : forall x : real, forall y : real, (real_le (real_of_num (NUMERAL N0)) (real_mul x y)) = ((x = (real_of_num (NUMERAL N0))) \/ ((y = (real_of_num (NUMERAL N0))) \/ (((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_of_num (NUMERAL N0)) y)) \/ ((real_lt x (real_of_num (NUMERAL N0))) /\ (real_lt y (real_of_num (NUMERAL N0))))))).
Axiom thm_REAL_LE_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_le x (real_div y z)) = (real_le (real_mul x z) y).
Axiom thm_REAL_LE_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_le (real_div x z) y) = (real_le x (real_mul y z)).
Axiom thm_REAL_LT_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_lt x (real_div y z)) = (real_lt (real_mul x z) y).
Axiom thm_REAL_LT_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_lt (real_div x z) y) = (real_lt x (real_mul y z)).
Axiom thm_REAL_EQ_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (x = (real_div y z)) = ((real_mul x z) = y).
Axiom thm_REAL_EQ_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> ((real_div x z) = y) = (x = (real_mul y z)).
Axiom thm_REAL_LT_DIV2_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_lt (real_div x z) (real_div y z)) = (real_lt x y).
Axiom thm_REAL_LE_DIV2_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL N0)) z) -> (real_le (real_div x z) (real_div y z)) = (real_le x y).
Axiom thm_REAL_MUL_2 : forall x : real, (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) x) = (real_add x x).
Axiom thm_REAL_POW_EQ_0 : forall x : real, forall n : N, ((real_pow x n) = (real_of_num (NUMERAL N0))) = ((x = (real_of_num (NUMERAL N0))) /\ (~ (n = (NUMERAL N0)))).
Axiom thm_REAL_LE_MUL2 : forall w : real, forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (NUMERAL N0)) w) /\ ((real_le w x) /\ ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_le y z)))) -> real_le (real_mul w y) (real_mul x z).
Axiom thm_REAL_LT_MUL2 : forall w : real, forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (NUMERAL N0)) w) /\ ((real_lt w x) /\ ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_lt y z)))) -> real_lt (real_mul w y) (real_mul x z).
Axiom thm_REAL_LT_SQUARE : forall x : real, (real_lt (real_of_num (NUMERAL N0)) (real_mul x x)) = (~ (x = (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_POW_1 : forall x : real, (real_pow x (NUMERAL (BIT1 N0))) = x.
Axiom thm_REAL_POW_ONE : forall n : N, (real_pow (real_of_num (NUMERAL (BIT1 N0))) n) = (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_LT_INV2 : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt x y)) -> real_lt (real_inv y) (real_inv x).
Axiom thm_REAL_LE_INV2 : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_le x y)) -> real_le (real_inv y) (real_inv x).
Axiom thm_REAL_LT_LINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) y) /\ (real_lt (real_inv y) x)) -> real_lt (real_inv x) y.
Axiom thm_REAL_LT_RINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt x (real_inv y))) -> real_lt y (real_inv x).
Axiom thm_REAL_LE_LINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) y) /\ (real_le (real_inv y) x)) -> real_le (real_inv x) y.
Axiom thm_REAL_LE_RINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_le x (real_inv y))) -> real_le y (real_inv x).
Axiom thm_REAL_INV_LE_1 : forall x : real, (real_le (real_of_num (NUMERAL (BIT1 N0))) x) -> real_le (real_inv x) (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_INV_1_LE : forall x : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_le x (real_of_num (NUMERAL (BIT1 N0))))) -> real_le (real_of_num (NUMERAL (BIT1 N0))) (real_inv x).
Axiom thm_REAL_INV_LT_1 : forall x : real, (real_lt (real_of_num (NUMERAL (BIT1 N0))) x) -> real_lt (real_inv x) (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_INV_1_LT : forall x : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt x (real_of_num (NUMERAL (BIT1 N0))))) -> real_lt (real_of_num (NUMERAL (BIT1 N0))) (real_inv x).
Axiom thm_REAL_SUB_INV : forall x : real, forall y : real, ((~ (x = (real_of_num (NUMERAL N0)))) /\ (~ (y = (real_of_num (NUMERAL N0))))) -> (real_sub (real_inv x) (real_inv y)) = (real_div (real_sub y x) (real_mul x y)).
Axiom thm_REAL_DOWN : forall d : real, (real_lt (real_of_num (NUMERAL N0)) d) -> exists e : real, (real_lt (real_of_num (NUMERAL N0)) e) /\ (real_lt e d).
Axiom thm_REAL_DOWN2 : forall d1 : real, forall d2 : real, ((real_lt (real_of_num (NUMERAL N0)) d1) /\ (real_lt (real_of_num (NUMERAL N0)) d2)) -> exists e : real, (real_lt (real_of_num (NUMERAL N0)) e) /\ ((real_lt e d1) /\ (real_lt e d2)).
Axiom thm_REAL_POW_LE2 : forall n : N, forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le x y)) -> real_le (real_pow x n) (real_pow y n).
Axiom thm_REAL_POW_LE_1 : forall n : N, forall x : real, (real_le (real_of_num (NUMERAL (BIT1 N0))) x) -> real_le (real_of_num (NUMERAL (BIT1 N0))) (real_pow x n).
Axiom thm_REAL_POW_1_LE : forall n : N, forall x : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le x (real_of_num (NUMERAL (BIT1 N0))))) -> real_le (real_pow x n) (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_POW_MONO : forall m : N, forall n : N, forall x : real, ((real_le (real_of_num (NUMERAL (BIT1 N0))) x) /\ (N.le m n)) -> real_le (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_LT2 : forall n : N, forall x : real, forall y : real, ((~ (n = (NUMERAL N0))) /\ ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_lt x y))) -> real_lt (real_pow x n) (real_pow y n).
Axiom thm_REAL_POW_LT_1 : forall n : N, forall x : real, ((~ (n = (NUMERAL N0))) /\ (real_lt (real_of_num (NUMERAL (BIT1 N0))) x)) -> real_lt (real_of_num (NUMERAL (BIT1 N0))) (real_pow x n).
Axiom thm_REAL_POW_1_LT : forall n : N, forall x : real, ((~ (n = (NUMERAL N0))) /\ ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_lt x (real_of_num (NUMERAL (BIT1 N0)))))) -> real_lt (real_pow x n) (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_POW_MONO_LT : forall m : N, forall n : N, forall x : real, ((real_lt (real_of_num (NUMERAL (BIT1 N0))) x) /\ (N.lt m n)) -> real_lt (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_POW : forall x : real, forall m : N, forall n : N, (real_pow (real_pow x m) n) = (real_pow x (N.mul m n)).
Axiom thm_REAL_EQ_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((~ (z = (real_of_num (NUMERAL N0)))) /\ ((real_mul x z) = (real_mul y z))) -> x = y.
Axiom thm_REAL_EQ_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((~ (z = (real_of_num (NUMERAL N0)))) /\ ((real_mul z x) = (real_mul z y))) -> x = y.
Axiom thm_REAL_LT_DIV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) x) /\ (real_lt (real_of_num (NUMERAL N0)) y)) -> real_lt (real_of_num (NUMERAL N0)) (real_div x y).
Axiom thm_REAL_LE_DIV : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le (real_of_num (NUMERAL N0)) y)) -> real_le (real_of_num (NUMERAL N0)) (real_div x y).
Axiom thm_REAL_DIV_POW2 : forall x : real, forall m : N, forall n : N, (~ (x = (real_of_num (NUMERAL N0)))) -> (real_div (real_pow x m) (real_pow x n)) = (@COND real (N.le n m) (real_pow x (N.sub m n)) (real_inv (real_pow x (N.sub n m)))).
Axiom thm_REAL_DIV_POW2_ALT : forall x : real, forall m : N, forall n : N, (~ (x = (real_of_num (NUMERAL N0)))) -> (real_div (real_pow x m) (real_pow x n)) = (@COND real (N.lt n m) (real_pow x (N.sub m n)) (real_inv (real_pow x (N.sub n m)))).
Axiom thm_REAL_LT_POW2 : forall n : N, real_lt (real_of_num (NUMERAL N0)) (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) n).
Axiom thm_REAL_LE_POW2 : forall n : N, real_le (real_of_num (NUMERAL (BIT1 N0))) (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) n).
Axiom thm_REAL_POW2_ABS : forall x : real, (real_pow (real_abs x) (NUMERAL (BIT0 (BIT1 N0)))) = (real_pow x (NUMERAL (BIT0 (BIT1 N0)))).
Axiom thm_REAL_LE_SQUARE_ABS : forall x : real, forall y : real, (real_le (real_abs x) (real_abs y)) = (real_le (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) (real_pow y (NUMERAL (BIT0 (BIT1 N0))))).
Axiom thm_REAL_LT_SQUARE_ABS : forall x : real, forall y : real, (real_lt (real_abs x) (real_abs y)) = (real_lt (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) (real_pow y (NUMERAL (BIT0 (BIT1 N0))))).
Axiom thm_REAL_EQ_SQUARE_ABS : forall x : real, forall y : real, ((real_abs x) = (real_abs y)) = ((real_pow x (NUMERAL (BIT0 (BIT1 N0)))) = (real_pow y (NUMERAL (BIT0 (BIT1 N0))))).
Axiom thm_REAL_LE_POW_2 : forall x : real, real_le (real_of_num (NUMERAL N0)) (real_pow x (NUMERAL (BIT0 (BIT1 N0)))).
Axiom thm_REAL_LT_POW_2 : forall x : real, (real_lt (real_of_num (NUMERAL N0)) (real_pow x (NUMERAL (BIT0 (BIT1 N0))))) = (~ (x = (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_SOS_EQ_0 : forall x : real, forall y : real, ((real_add (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) (real_pow y (NUMERAL (BIT0 (BIT1 N0))))) = (real_of_num (NUMERAL N0))) = ((x = (real_of_num (NUMERAL N0))) /\ (y = (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_POW_ZERO : forall n : N, (real_pow (real_of_num (NUMERAL N0)) n) = (@COND real (n = (NUMERAL N0)) (real_of_num (NUMERAL (BIT1 N0))) (real_of_num (NUMERAL N0))).
Axiom thm_REAL_POW_MONO_INV : forall m : N, forall n : N, forall x : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ ((real_le x (real_of_num (NUMERAL (BIT1 N0)))) /\ (N.le n m))) -> real_le (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_LE2_REV : forall n : N, forall x : real, forall y : real, ((~ (n = (NUMERAL N0))) /\ ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_le (real_pow x n) (real_pow y n)))) -> real_le x y.
Axiom thm_REAL_POW_LT2_REV : forall n : N, forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_lt (real_pow x n) (real_pow y n))) -> real_lt x y.
Axiom thm_REAL_POW_EQ : forall n : N, forall x : real, forall y : real, ((~ (n = (NUMERAL N0))) /\ ((real_le (real_of_num (NUMERAL N0)) x) /\ ((real_le (real_of_num (NUMERAL N0)) y) /\ ((real_pow x n) = (real_pow y n))))) -> x = y.
Axiom thm_REAL_POW_EQ_ABS : forall n : N, forall x : real, forall y : real, ((~ (n = (NUMERAL N0))) /\ ((real_pow x n) = (real_pow y n))) -> (real_abs x) = (real_abs y).
Axiom thm_REAL_POW_EQ_1_IMP : forall x : real, forall n : N, ((~ (n = (NUMERAL N0))) /\ ((real_pow x n) = (real_of_num (NUMERAL (BIT1 N0))))) -> (real_abs x) = (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_REAL_POW_EQ_1 : forall x : real, forall n : N, ((real_pow x n) = (real_of_num (NUMERAL (BIT1 N0)))) = ((((real_abs x) = (real_of_num (NUMERAL (BIT1 N0)))) /\ ((real_lt x (real_of_num (NUMERAL N0))) -> N.Even n)) \/ (n = (NUMERAL N0))).
...
Axiom thm_REAL_POW_EQ_EQ : forall n : N, forall x : real, forall y : real, ((real_pow x n) = (real_pow y n)) = (@COND Prop (N.Even n) ((n = (NUMERAL N0)) \/ ((real_abs x) = (real_abs y))) (x = y)).
...
Axiom thm_REAL_CONVEX_BOUND2_LT : forall (b : real), forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt x a) /\ ((real_lt y b) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))) -> real_lt (real_add (real_mul u x) (real_mul v y)) (real_add (real_mul u a) (real_mul v b)).
Axiom thm_REAL_CONVEX_BOUND2_LE : forall (b : real), forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le x a) /\ ((real_le y b) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))) -> real_le (real_add (real_mul u x) (real_mul v y)) (real_add (real_mul u a) (real_mul v b)).
Axiom thm_REAL_CONVEX_BOUND_LT : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt x a) /\ ((real_lt y a) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))) -> real_lt (real_add (real_mul u x) (real_mul v y)) a.
Axiom thm_REAL_CONVEX_BOUND_LE : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le x a) /\ ((real_le y a) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))) -> real_le (real_add (real_mul u x) (real_mul v y)) a.
Axiom thm_REAL_CONVEX_BOUND_GT : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt a x) /\ ((real_lt a y) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))) -> real_lt a (real_add (real_mul u x) (real_mul v y)).
Axiom thm_REAL_CONVEX_BOUND_GE : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le a x) /\ ((real_le a y) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))) -> real_le a (real_add (real_mul u x) (real_mul v y)).
Axiom thm_REAL_CONVEX_BOUNDS_LE : forall x : real, forall y : real, forall a : real, forall b : real, forall u : real, forall v : real, ((real_le a x) /\ ((real_le x b) /\ ((real_le a y) /\ ((real_le y b) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))))) -> (real_le a (real_add (real_mul u x) (real_mul v y))) /\ (real_le (real_add (real_mul u x) (real_mul v y)) b).
Axiom thm_REAL_CONVEX_BOUNDS_LT : forall x : real, forall y : real, forall a : real, forall b : real, forall u : real, forall v : real, ((real_lt a x) /\ ((real_lt x b) /\ ((real_lt a y) /\ ((real_lt y b) /\ ((real_le (real_of_num (NUMERAL N0)) u) /\ ((real_le (real_of_num (NUMERAL N0)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 N0)))))))))) -> (real_lt a (real_add (real_mul u x) (real_mul v y))) /\ (real_lt (real_add (real_mul u x) (real_mul v y)) b).
...
Axiom thm_REAL_ARCH : forall x : real, (real_lt (real_of_num (NUMERAL N0)) x) -> forall y : real, exists n : N, real_lt y (real_mul (real_of_num n) x).
Axiom thm_REAL_ARCH_INV : forall e : real, (real_lt (real_of_num (NUMERAL N0)) e) = (exists n : N, (~ (n = (NUMERAL N0))) /\ ((real_lt (real_of_num (NUMERAL N0)) (real_inv (real_of_num n))) /\ (real_lt (real_inv (real_of_num n)) e))).
Axiom thm_REAL_POW_LBOUND : forall x : real, forall n : N, (real_le (real_of_num (NUMERAL N0)) x) -> real_le (real_add (real_of_num (NUMERAL (BIT1 N0))) (real_mul (real_of_num n) x)) (real_pow (real_add (real_of_num (NUMERAL (BIT1 N0))) x) n).
Axiom thm_REAL_ARCH_POW : forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL (BIT1 N0))) x) -> exists n : N, real_lt y (real_pow x n).
Axiom thm_REAL_ARCH_POW2 : forall x : real, exists n : N, real_lt x (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) n).
Axiom thm_REAL_ARCH_POW_INV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL N0)) y) /\ (real_lt x (real_of_num (NUMERAL (BIT1 N0))))) -> exists n : N, real_lt (real_pow x n) y.
Axiom thm_real_sgn : forall x : real, (real_sgn x) = (@COND real (real_lt (real_of_num (NUMERAL N0)) x) (real_of_num (NUMERAL (BIT1 N0))) (@COND real (real_lt x (real_of_num (NUMERAL N0))) (real_neg (real_of_num (NUMERAL (BIT1 N0)))) (real_of_num (NUMERAL N0)))).
Axiom thm_REAL_SGN_0 : (real_sgn (real_of_num (NUMERAL N0))) = (real_of_num (NUMERAL N0)).
...
Axiom thm_REAL_SGN_EQ : (forall x : real, ((real_sgn x) = (real_of_num (NUMERAL N0))) = (x = (real_of_num (NUMERAL N0)))) /\ ((forall x : real, ((real_sgn x) = (real_of_num (NUMERAL (BIT1 N0)))) = (real_gt x (real_of_num (NUMERAL N0)))) /\ (forall x : real, ((real_sgn x) = (real_neg (real_of_num (NUMERAL (BIT1 N0))))) = (real_lt x (real_of_num (NUMERAL N0))))).
Axiom thm_REAL_SGN_CASES : forall x : real, ((real_sgn x) = (real_of_num (NUMERAL N0))) \/ (((real_sgn x) = (real_of_num (NUMERAL (BIT1 N0)))) \/ ((real_sgn x) = (real_neg (real_of_num (NUMERAL (BIT1 N0)))))).
Axiom thm_REAL_SGN_INEQS : (forall x : real, (real_le (real_of_num (NUMERAL N0)) (real_sgn x)) = (real_le (real_of_num (NUMERAL N0)) x)) /\ ((forall x : real, (real_lt (real_of_num (NUMERAL N0)) (real_sgn x)) = (real_lt (real_of_num (NUMERAL N0)) x)) /\ ((forall x : real, (real_ge (real_of_num (NUMERAL N0)) (real_sgn x)) = (real_ge (real_of_num (NUMERAL N0)) x)) /\ ((forall x : real, (real_gt (real_of_num (NUMERAL N0)) (real_sgn x)) = (real_gt (real_of_num (NUMERAL N0)) x)) /\ ((forall x : real, ((real_of_num (NUMERAL N0)) = (real_sgn x)) = ((real_of_num (NUMERAL N0)) = x)) /\ ((forall x : real, (real_le (real_sgn x) (real_of_num (NUMERAL N0))) = (real_le x (real_of_num (NUMERAL N0)))) /\ ((forall x : real, (real_lt (real_sgn x) (real_of_num (NUMERAL N0))) = (real_lt x (real_of_num (NUMERAL N0)))) /\ ((forall x : real, (real_ge (real_sgn x) (real_of_num (NUMERAL N0))) = (real_ge x (real_of_num (NUMERAL N0)))) /\ ((forall x : real, (real_gt (real_sgn x) (real_of_num (NUMERAL N0))) = (real_gt x (real_of_num (NUMERAL N0)))) /\ (forall x : real, ((real_sgn x) = (real_of_num (NUMERAL N0))) = (x = (real_of_num (NUMERAL N0)))))))))))).
Axiom thm_REAL_SGN_POW : forall x : real, forall n : N, (real_sgn (real_pow x n)) = (real_pow (real_sgn x) n).
Axiom thm_REAL_SGN_POW_2 : forall x : real, (real_sgn (real_pow x (NUMERAL (BIT0 (BIT1 N0))))) = (real_sgn (real_abs x)).
...
Axiom thm_REAL_SGNS_EQ : forall x : real, forall y : real, ((real_sgn x) = (real_sgn y)) = (((x = (real_of_num (NUMERAL N0))) = (y = (real_of_num (NUMERAL N0)))) /\ (((real_gt x (real_of_num (NUMERAL N0))) = (real_gt y (real_of_num (NUMERAL N0)))) /\ ((real_lt x (real_of_num (NUMERAL N0))) = (real_lt y (real_of_num (NUMERAL N0)))))).
Axiom thm_REAL_SGNS_EQ_ALT : forall x : real, forall y : real, ((real_sgn x) = (real_sgn y)) = (((x = (real_of_num (NUMERAL N0))) -> y = (real_of_num (NUMERAL N0))) /\ (((real_gt x (real_of_num (NUMERAL N0))) -> real_gt y (real_of_num (NUMERAL N0))) /\ ((real_lt x (real_of_num (NUMERAL N0))) -> real_lt y (real_of_num (NUMERAL N0))))).
...
Axiom thm_sqrt : forall x : real, (sqrt x) = (@ε real (fun y : real => ((real_sgn y) = (real_sgn x)) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 N0)))) = (real_abs x)))).
Axiom thm_SQRT_UNIQUE : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) y) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 N0)))) = x)) -> (sqrt x) = y.
Axiom thm_POW_2_SQRT : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> (sqrt (real_pow x (NUMERAL (BIT0 (BIT1 N0))))) = x.
Axiom thm_SQRT_0 : (sqrt (real_of_num (NUMERAL N0))) = (real_of_num (NUMERAL N0)).
Axiom thm_SQRT_1 : (sqrt (real_of_num (NUMERAL (BIT1 N0)))) = (real_of_num (NUMERAL (BIT1 N0))).
Axiom thm_POW_2_SQRT_ABS : forall x : real, (sqrt (real_pow x (NUMERAL (BIT0 (BIT1 N0))))) = (real_abs x).
Axiom thm_SQRT_WORKS_GEN : forall x : real, ((real_sgn (sqrt x)) = (real_sgn x)) /\ ((real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 N0)))) = (real_abs x)).
Axiom thm_SQRT_UNIQUE_GEN : forall x : real, forall y : real, (((real_sgn y) = (real_sgn x)) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 N0)))) = (real_abs x))) -> (sqrt x) = y.
...
Axiom thm_SQRT_WORKS : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> (real_le (real_of_num (NUMERAL N0)) (sqrt x)) /\ ((real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 N0)))) = x).
Axiom thm_REAL_POS_EQ_SQUARE : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) = (exists y : real, (real_pow y (NUMERAL (BIT0 (BIT1 N0)))) = x).
Axiom thm_SQRT_POS_LE : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> real_le (real_of_num (NUMERAL N0)) (sqrt x).
Axiom thm_SQRT_POW_2 : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> (real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 N0)))) = x.
Axiom thm_SQRT_POW2 : forall x : real, ((real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 N0)))) = x) = (real_le (real_of_num (NUMERAL N0)) x).
...
Axiom thm_SQRT_LT_0 : forall x : real, (real_lt (real_of_num (NUMERAL N0)) (sqrt x)) = (real_lt (real_of_num (NUMERAL N0)) x).
Axiom thm_SQRT_EQ_0 : forall x : real, ((sqrt x) = (real_of_num (NUMERAL N0))) = (x = (real_of_num (NUMERAL N0))).
Axiom thm_SQRT_LE_0 : forall x : real, (real_le (real_of_num (NUMERAL N0)) (sqrt x)) = (real_le (real_of_num (NUMERAL N0)) x).
...
Axiom thm_SQRT_EQ_1 : forall x : real, ((sqrt x) = (real_of_num (NUMERAL (BIT1 N0)))) = (x = (real_of_num (NUMERAL (BIT1 N0)))).
Axiom thm_SQRT_POS_LT : forall x : real, (real_lt (real_of_num (NUMERAL N0)) x) -> real_lt (real_of_num (NUMERAL N0)) (sqrt x).
Axiom thm_REAL_LE_LSQRT : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_le x (real_pow y (NUMERAL (BIT0 (BIT1 N0)))))) -> real_le (sqrt x) y.
Axiom thm_REAL_LE_RSQRT : forall x : real, forall y : real, (real_le (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) y) -> real_le x (sqrt y).
Axiom thm_REAL_LT_LSQRT : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_lt x (real_pow y (NUMERAL (BIT0 (BIT1 N0)))))) -> real_lt (sqrt x) y.
Axiom thm_REAL_LT_RSQRT : forall x : real, forall y : real, (real_lt (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) y) -> real_lt x (sqrt y).
Axiom thm_SQRT_EVEN_POW2 : forall n : N, (N.Even n) -> (sqrt (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) n)) = (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) (N.div n (NUMERAL (BIT0 (BIT1 N0))))).
Axiom thm_REAL_DIV_SQRT : forall x : real, (real_le (real_of_num (NUMERAL N0)) x) -> (real_div x (sqrt x)) = (sqrt x).
Axiom thm_REAL_RSQRT_LE : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ ((real_le (real_of_num (NUMERAL N0)) y) /\ (real_le x (sqrt y)))) -> real_le (real_pow x (NUMERAL (BIT0 (BIT1 N0)))) y.
Axiom thm_REAL_LSQRT_LE : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le (sqrt x) y)) -> real_le x (real_pow y (NUMERAL (BIT0 (BIT1 N0)))).
Axiom thm_REAL_SQRT_POW_2 : forall x : real, (real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 N0)))) = (real_abs x).
Axiom thm_REAL_ABS_LE_SQRT_POS : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL N0)) x) /\ (real_le (real_of_num (NUMERAL N0)) y)) -> real_le (real_abs (real_sub (sqrt x) (sqrt y))) (sqrt (real_abs (real_sub x y))).
Axiom thm_REAL_ABS_LE_SQRT : forall x : real, forall y : real, real_le (real_abs (real_sub (sqrt x) (sqrt y))) (sqrt (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 N0)))) (real_abs (real_sub x y)))).
