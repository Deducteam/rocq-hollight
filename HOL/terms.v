...
Definition sum {A : Type'} : (A -> Prop) -> (A -> R) -> R := @iterate A R addr.
...
Definition dollar {A N' : Type'} : (cart A N') -> nat -> A := fun _94652 : cart A N' => fun _94653 : nat => @dest_cart A N' _94652 (@finite_index N' _94653).
