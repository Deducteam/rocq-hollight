...
Axiom thm_sqrt : forall x : R, (sqrt x) = (@ε R (fun y : R => ((sgr y) = (sgr x)) /\ ((expr y (NUMERAL (BIT0 (BIT1 O)))) = (normr x)))).
Axiom thm_SQRT_UNIQUE : forall x : R, forall y : R, ((ler (R_of_nat (NUMERAL O)) y) /\ ((expr y (NUMERAL (BIT0 (BIT1 O)))) = x)) -> (sqrt x) = y.
Axiom thm_POW_2_SQRT : forall x : R, (ler (R_of_nat (NUMERAL O)) x) -> (sqrt (expr x (NUMERAL (BIT0 (BIT1 O))))) = x.
Axiom thm_SQRT_0 : (sqrt (R_of_nat (NUMERAL O))) = (R_of_nat (NUMERAL O)).
Axiom thm_SQRT_1 : (sqrt (R_of_nat (NUMERAL (BIT1 O)))) = (R_of_nat (NUMERAL (BIT1 O))).
Axiom thm_POW_2_SQRT_ABS : forall x : R, (sqrt (expr x (NUMERAL (BIT0 (BIT1 O))))) = (normr x).
Axiom thm_SQRT_WORKS_GEN : forall x : R, ((sgr (sqrt x)) = (sgr x)) /\ ((expr (sqrt x) (NUMERAL (BIT0 (BIT1 O)))) = (normr x)).
Axiom thm_SQRT_UNIQUE_GEN : forall x : R, forall y : R, (((sgr y) = (sgr x)) /\ ((expr y (NUMERAL (BIT0 (BIT1 O)))) = (normr x))) -> (sqrt x) = y.
Axiom thm_SQRT_NEG : forall x : R, (sqrt (oppr x)) = (oppr (sqrt x)).
Axiom thm_REAL_SGN_SQRT : forall x : R, (sgr (sqrt x)) = (sgr x).
Axiom thm_SQRT_WORKS : forall x : R, (ler (R_of_nat (NUMERAL O)) x) -> (ler (R_of_nat (NUMERAL O)) (sqrt x)) /\ ((expr (sqrt x) (NUMERAL (BIT0 (BIT1 O)))) = x).
Axiom thm_REAL_POS_EQ_SQUARE : forall x : R, (ler (R_of_nat (NUMERAL O)) x) = (exists y : R, (expr y (NUMERAL (BIT0 (BIT1 O)))) = x).
Axiom thm_SQRT_POS_LE : forall x : R, (ler (R_of_nat (NUMERAL O)) x) -> ler (R_of_nat (NUMERAL O)) (sqrt x).
Axiom thm_SQRT_POW_2 : forall x : R, (ler (R_of_nat (NUMERAL O)) x) -> (expr (sqrt x) (NUMERAL (BIT0 (BIT1 O)))) = x.
Axiom thm_SQRT_POW2 : forall x : R, ((expr (sqrt x) (NUMERAL (BIT0 (BIT1 O)))) = x) = (ler (R_of_nat (NUMERAL O)) x).
Axiom thm_SQRT_MUL : forall x : R, forall y : R, (sqrt (mulr x y)) = (mulr (sqrt x) (sqrt y)).
Axiom thm_SQRT_INV : forall x : R, (sqrt (invr x)) = (invr (sqrt x)).
Axiom thm_SQRT_DIV : forall x : R, forall y : R, (sqrt (divr x y)) = (divr (sqrt x) (sqrt y)).
Axiom thm_SQRT_LT_0 : forall x : R, (ltr (R_of_nat (NUMERAL O)) (sqrt x)) = (ltr (R_of_nat (NUMERAL O)) x).
Axiom thm_SQRT_EQ_0 : forall x : R, ((sqrt x) = (R_of_nat (NUMERAL O))) = (x = (R_of_nat (NUMERAL O))).
Axiom thm_SQRT_LE_0 : forall x : R, (ler (R_of_nat (NUMERAL O)) (sqrt x)) = (ler (R_of_nat (NUMERAL O)) x).
Axiom thm_REAL_ABS_SQRT : forall x : R, (normr (sqrt x)) = (sqrt (normr x)).
Axiom thm_SQRT_MONO_LT : forall x : R, forall y : R, (ltr x y) -> ltr (sqrt x) (sqrt y).
Axiom thm_SQRT_MONO_LE : forall x : R, forall y : R, (ler x y) -> ler (sqrt x) (sqrt y).
Axiom thm_SQRT_MONO_LT_EQ : forall x : R, forall y : R, (ltr (sqrt x) (sqrt y)) = (ltr x y).
Axiom thm_SQRT_MONO_LE_EQ : forall x : R, forall y : R, (ler (sqrt x) (sqrt y)) = (ler x y).
Axiom thm_SQRT_INJ : forall x : R, forall y : R, ((sqrt x) = (sqrt y)) = (x = y).
Axiom thm_SQRT_EQ_1 : forall x : R, ((sqrt x) = (R_of_nat (NUMERAL (BIT1 O)))) = (x = (R_of_nat (NUMERAL (BIT1 O)))).
Axiom thm_SQRT_POS_LT : forall x : R, (ltr (R_of_nat (NUMERAL O)) x) -> ltr (R_of_nat (NUMERAL O)) (sqrt x).
Axiom thm_REAL_LE_LSQRT : forall x : R, forall y : R, ((ler (R_of_nat (NUMERAL O)) y) /\ (ler x (expr y (NUMERAL (BIT0 (BIT1 O)))))) -> ler (sqrt x) y.
Axiom thm_REAL_LE_RSQRT : forall x : R, forall y : R, (ler (expr x (NUMERAL (BIT0 (BIT1 O)))) y) -> ler x (sqrt y).
Axiom thm_REAL_LT_LSQRT : forall x : R, forall y : R, ((ler (R_of_nat (NUMERAL O)) y) /\ (ltr x (expr y (NUMERAL (BIT0 (BIT1 O)))))) -> ltr (sqrt x) y.
Axiom thm_REAL_LT_RSQRT : forall x : R, forall y : R, (ltr (expr x (NUMERAL (BIT0 (BIT1 O)))) y) -> ltr x (sqrt y).
Axiom thm_SQRT_EVEN_POW2 : forall n : nat, (even n) -> (sqrt (expr (R_of_nat (NUMERAL (BIT0 (BIT1 O)))) n)) = (expr (R_of_nat (NUMERAL (BIT0 (BIT1 O)))) (divn n (NUMERAL (BIT0 (BIT1 O))))).
Axiom thm_REAL_DIV_SQRT : forall x : R, (ler (R_of_nat (NUMERAL O)) x) -> (divr x (sqrt x)) = (sqrt x).
Axiom thm_REAL_RSQRT_LE : forall x : R, forall y : R, ((ler (R_of_nat (NUMERAL O)) x) /\ ((ler (R_of_nat (NUMERAL O)) y) /\ (ler x (sqrt y)))) -> ler (expr x (NUMERAL (BIT0 (BIT1 O)))) y.
Axiom thm_REAL_LSQRT_LE : forall x : R, forall y : R, ((ler (R_of_nat (NUMERAL O)) x) /\ (ler (sqrt x) y)) -> ler x (expr y (NUMERAL (BIT0 (BIT1 O)))).
Axiom thm_REAL_SQRT_POW_2 : forall x : R, (expr (sqrt x) (NUMERAL (BIT0 (BIT1 O)))) = (normr x).
Axiom thm_REAL_ABS_LE_SQRT_POS : forall x : R, forall y : R, ((ler (R_of_nat (NUMERAL O)) x) /\ (ler (R_of_nat (NUMERAL O)) y)) -> ler (normr (subr (sqrt x) (sqrt y))) (sqrt (normr (subr x y))).
Axiom thm_REAL_ABS_LE_SQRT : forall x : R, forall y : R, ler (normr (subr (sqrt x) (sqrt y))) (sqrt (mulr (R_of_nat (NUMERAL (BIT0 (BIT1 O)))) (normr (subr x y)))).
